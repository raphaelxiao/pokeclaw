...
6. 待机界面不仅包含生动的 **角色发呆动画**，还会显示时钟、日期、电池电量和 Wi-Fi 状态
7. 角色动画会根据当前状态流利地在 发呆(idle)、听(listening)、思考(thinking) 和 说话(talking) 之间平滑切换。说话时还会**根据 TTS 播报音量实时对口型**！
